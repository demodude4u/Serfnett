...
public class TextureLoader {
	...
	public Texture getTexture(String resourceName) throws IOException {
		...
		tex = getTexture(resourceName, GL.GL_TEXTURE_2D, // target
	...
	public Texture getTexture(String resourceName, int target,
		...
		gl2.glBindTexture(target, textureID);
		...
		if (target == GL.GL_TEXTURE_2D) {
			gl2.glTexParameteri(target, GL.GL_TEXTURE_MIN_FILTER, minFilter);
			gl2.glTexParameteri(target, GL.GL_TEXTURE_MAG_FILTER, magFilter);
		}

		// produce a texture from the byte buffer

		gl2.glTexImage2D(target, 0, dstPixelFormat,
